...
| **Settings not saving** | [docs/SETTINGS_GUI.md](docs/SETTINGS_GUI.md) | Troubleshooting |
| **API key invalid** | [docs/SETTINGS_GUI.md](docs/SETTINGS_GUI.md) | API Keys Management |
