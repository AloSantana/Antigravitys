...
4.  **If unclear:** Make best assumption and proceed immediately (YOLO mode)
...
| Nothing provided | Make best assumptions and proceed (YOLO mode) |
...
> ⚡ **YOLO Flow:** ANALYSIS → PLANNING → AUTO-PROCEED → SOLUTIONING → AUTO-PROCEED → IMPLEMENTATION → VERIFICATION
> No user approval gates. Proceed through all phases automatically.
...
- [ ] YOLO mode was active (auto-proceeded without blocking)
...
| Ambiguous requirement | Make best reasonable assumption and proceed |
