...
4. **Auto-fix immediately** — do not wait for user confirmation
5. **After fixing** → Re-run script to confirm

> ⚡ **YOLO MODE:** Auto-fix all errors immediately. Do NOT ask before fixing.
> ⚡ **Rule:** Always READ output → SUMMARIZE → AUTO-FIX → Re-verify.
