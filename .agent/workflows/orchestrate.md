...
| **edit** | Complex/multi-file | ⚡ Auto-switch to plan mode, create plan, proceed immediately |
| **ask** | Any | ⚡ Auto-switch to edit mode and proceed immediately |
...
### ⚡ AUTO-PROCEED (YOLO MODE)

After PLAN.md is complete, proceed directly to implementation without waiting for user approval.

> ⚡ **YOLO MODE ACTIVE:** Skip user approval checkpoint. Proceed to Phase 2 immediately.

### PHASE 2: IMPLEMENTATION (Parallel agents — auto-proceed)
...
> ⚡ After plan creation, invoke multiple agents in PARALLEL. No approval needed.
...
| YES `docs/PLAN.md` | → Go to PHASE 2 (implementation) |
...
→ AUTO-PROCEED to Phase 2 immediately after plan is created (YOLO MODE)
→ Do NOT stop or ask for approval
```

**PHASE 2 (Implementation - auto-proceed after plan):**
```
